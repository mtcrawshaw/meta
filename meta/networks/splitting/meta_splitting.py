"""
Definition of MetaSplittingNetwork, a trained MultiTaskSplittingNetwork adapted for
meta-test time.
"""
...
class MetaSplittingNetwork(nn.Module):
    ...
    def __init__(
        self, split_net: MultiTaskSplittingNetwork, device: torch.device = None,
    ) -> None:
        """
        ...
        Arguments
        ---------
        split_net : MultiTaskSplittingNetwork
    ...
    def initialize_network(self, split_net: MultiTaskSplittingNetwork) -> None:
