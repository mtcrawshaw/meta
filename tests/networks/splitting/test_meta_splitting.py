...
from meta.networks.splitting import MultiTaskSplittingNetwork, MetaSplittingNetwork
...
def test_forward_shared() -> None:
    ...
    multitask_network = MultiTaskSplittingNetwork(
        input_size=dim,
        output_size=dim,
        init_base=init_base,
    ...
    # Construct MetaSplittingNetwork from MultiTaskSplittingNetwork.
    ...
    expected_output = torch.zeros(SETTINGS["num_processes"], dim)
